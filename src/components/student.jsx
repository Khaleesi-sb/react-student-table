...
const Student = () => {
    ...
    async function Load() {
        const result = await axios.get(
            "http://localhost:9091/api/v1/student/getall");
    ...
    async function save(event) {
        ...
        try {
            await axios.post("http://localhost:9091/api/v1/student/save",
                {
    ...
    async function DeleteStudent(studentid) {
        await axios.delete("http://localhost:9091/api/v1/student/delete/" + studentid);
    ...
    async function update(event) {
        ...
        try {
            await axios.put("http://localhost:9091/api/v1/student/edit/" + studentid,
                {
